...
export const muarOtakOtak: DishBase = {
  id: DISH_IDS.MUAR_OTAK_OTAK,
  emoji: "🥘",
  name: "Muar Otak-Otak",
  chineseName: "麻坡乌达",
  description:
...
export const eggPrata: DishBase = {
  id: DISH_IDS.EGG_PRATA,
  emoji: "🫓",
  name: "Egg Prata",
  chineseName: "鸡蛋煎饼",
  description:
...
export const fishHeadCurry: DishBase = {
  id: DISH_IDS.FISH_HEAD_CURRY,
  emoji: "🐟",
...
export const beeHoonSoup: DishBase = {
  id: DISH_IDS.BEE_HOON_SOUP,
  emoji: "🍲",
  name: "Bee Hoon Soup",
  chineseName: "米粉汤",
  description:
...
export const yongTauFoo: DishBase = {
  id: DISH_IDS.YONG_TAU_FOO,
  emoji: "🧆",
  name: "Yong Tau Foo",
  chineseName: "酿豆腐",
  description:
...
export const friedCarrotCake: DishBase = {
  id: DISH_IDS.FRIED_CARROT_CAKE,
  emoji: "🍳",
...
export const oysterOmelette: DishBase = {
  id: DISH_IDS.OYSTER_OMLETTE,
  emoji: "🦪",
...
export const hokkienPrawnMee: DishBase = {
  id: DISH_IDS.HOKKIEN_PRAWN_MEE,
  emoji: "🍤",
...
export const singaporeCrab: DishBase = {
  id: DISH_IDS.SINGAPORE_CRAB,
  emoji: "🦀",
...
export const duckRice: DishBase = {
  id: DISH_IDS.DUCK_RICE,
  emoji: "🦆",
  name: "Duck Rice",
  chineseName: "鸭饭",
  description:
...
export const porkCongee: DishBase = {
  id: DISH_IDS.PORK_CONGEE,
  emoji: "🥣",
  name: "Pork Congee",
  chineseName: "猪肉粥",
  description:
...
export const sambalStingray: DishBase = {
...
export const horFun: DishBase = {
  ...
  quote: "Why complicate things when simplicity is ultimate sophistication? 🎋",
  category: "Hawker Classic",
  quizAttributes: {
    energyLevel: "low",
    socialPreference: "introvert",
...
export const mincedMeatNoodle: DishBase = {
  id: DISH_IDS.MINCED_MEAT_NOODLE,
  emoji: "🥢",
...
export const wantonMee: DishBase = {
  id: DISH_IDS.WANTON_MEE,
  emoji: "🥟",
  name: "Wanton Mee",
  chineseName: "云吞面",
  description:
...
export const curryRice: DishBase = {
  id: DISH_IDS.CURRY_RICE,
  emoji: "🍛",
  name: "Curry Rice",
  chineseName: "咖喱饭",
  description:
...
export const cheeCheongFun: DishBase = {
  id: DISH_IDS.CHEE_CHEONG_FUN,
  emoji: "🫔",
...
export const youTiao: DishBase = {
  id: DISH_IDS.YOU_TIAO,
  emoji: "🥢",
  name: "You Tiao",
  chineseName: "油条",
  description:
